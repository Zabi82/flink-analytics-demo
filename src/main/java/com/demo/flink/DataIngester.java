...
public class DataIngester {
    ...
    public static void main(String[] args) {
        Thread kafkaProducerThread = new Thread(new TaxiBookingProducerRunnable(TaxiBookingDataKafkaProducer.INSTANCE, LocationTheme.REGULAR, 500));
        Thread fileProducerThread = new Thread(new TaxiBookingProducerRunnable(TaxiBookingDataFileProducer.INSTANCE, LocationTheme.REGULAR, 1000));
